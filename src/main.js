...
window.draw           = draw;
window.saveProject    = () => import('./io/export-project.js').then(m => m.saveProject()).catch(() => showToast("Spara projekt: Fas 6", "#ff9900"));
window.exportGeoFile  = () => import('./io/import-geo.js').then(m => m.exportGeoFile()).catch(() => showToast("Exportera .geo: Fas 6", "#ff9900"));
window.showExcelTemplate = () => showToast("Excel-mall: Fas 6", "#ff9900");
window.cvSaveNewRow   = () => {};
window.cvAddRow       = () => {};
window.cvImportGeo    = () => {};
window.cvExportGeo    = () => {};
